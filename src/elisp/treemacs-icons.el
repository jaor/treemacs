...
(defvar treemacs-icon-root       nil)
(defvar treemacs-icon-fallback   nil)
(defvar treemacs-icon-dir-open   nil)
(defvar treemacs-icon-dir-closed nil)
(defvar treemacs-icon-tag-open   nil)
(defvar treemacs-icon-tag-closed nil)
(defvar treemacs-icon-tag-leaf   nil)
(defvar treemacs-icon-info       nil)
(defvar treemacs-icon-warning    nil)
(defvar treemacs-icon-error      nil)

(defconst treemacs--icon-symbols
  '(root fallback dir-open dir-closed tag-open tag-closed tag-leaf info warning error)
...
- EXTENSIONS is a list of file extensions the icon should be used for.
  Note that treemacs has a losse understanding of what constitutes an extension:
  ...
  Finally there is a limited set of special extensions which are symbols and not
  strings. They are used to identify special icons defined in their own
  variables, like `treemacs-icon-dir-open'. These are listed in
  `treemacs--icon-symbols'."
